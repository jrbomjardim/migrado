...
from src.routes.question_lists import question_lists_bp
...
app.config['SECRET_KEY'] = 'medcards-secret-key-2024'
...
app.register_blueprint(question_lists_bp, url_prefix='/api')
